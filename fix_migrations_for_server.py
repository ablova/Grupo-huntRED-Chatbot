...
Creado: Mayo 2025
Autor: Equipo de Desarrollo huntRED
"""
import os
import sys
import datetime
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.URLField(blank=True, help_text='URL base de la API de WordPress (ej: https://huntu.mx/wp-json/wp/v2)', max_length=255, null=True, verbose_name='URL base de WordPress'),
        ),
        migrations.AddField(
            model_name='businessunit',  # Corregido: este es el modelo correcto
            name='wordpress_auth_token',
            field=models.CharField(blank=True, help_text='Token de autenticación para la API de WordPress', max_length=255, null=True, verbose_name='Token de WordPress'),
        ),
        migrations.AddField(
            model_name='businessunit',
            name='wp_config_updated_at',
            field=models.DateTimeField(auto_now=True, help_text='Fecha de última actualización de la configuración WordPress', null=True, verbose_name='Última actualización WP'),
        ),
    ]
"""
