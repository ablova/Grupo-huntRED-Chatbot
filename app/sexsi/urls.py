...
from app.sexsi.views import (
    ...
    download_pdf, save_biometric_signature, save_signature
)
...
urlpatterns = [
    ...
    path('sign/biometric/<int:agreement_id>/<str:signer>/<uuid:token>/', save_biometric_signature, name='save_biometric_signature'),
    path('sign/save/<int:agreement_id>/<str:signer>/<uuid:token>/', save_signature, name='save_signature'),
]