...
def setup_onboarding_tasks():
    ...
    try:
        ...
        PeriodicTask.objects.update_or_create(
            ...
            defaults={
                'task': 'app.ats.onboarding.client_feedback_tasks.check_pending_client_feedback_task',
                'crontab': schedule,
                'enabled': True,
        ...
        PeriodicTask.objects.update_or_create(
            ...
            defaults={
                'task': 'app.ats.onboarding.client_feedback_tasks.generate_client_feedback_reports_task',
                'crontab': schedule,
                'enabled': True,
        ...
        PeriodicTask.objects.update_or_create(
            ...
            defaults={
                'task': 'app.ats.onboarding.client_feedback_tasks.analyze_client_feedback_trends_task',
                'crontab': schedule,
                'enabled': True,
