"""
Integración con Coursera para el sistema de aprendizaje.
"""
...
class CourseraIntegration(BaseIntegration):
    """Integración con Coursera."""
    ...
    async def get_courses(self, skills: List[str]) -> List[Dict[str, Any]]:
        """
        Obtiene cursos de Coursera basados en skills.
        ...
        try:
            ...
            logger.error(f"Error obteniendo cursos de Coursera: {str(e)}")
            return []
