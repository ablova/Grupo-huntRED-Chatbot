...
from app.ats.chatbot.integrations.services import EmailService, send_message, send_options_async, send_menu
...
# /home/pablo/app/com/chatbot/workflow/amigro.py (solo tareas de Celery ajustadas)
@shared_task
