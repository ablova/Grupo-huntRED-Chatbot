...
from app.ats.chatbot.models.chat_state import ChatState
from app.ats.chatbot.models.profile import Profile
from app.ats.chatbot.integrations.services import MENU_OPTIONS_BY_BU, EVALUATIONS_MENU
...
from app.ats.chatbot.workflow.assessments.professional_dna.questions import BusinessUnit, QuestionCategory
from app.ats.chatbot.workflow.assessments.professional_dna.analysis import AnalysisType
from app.ats.chatbot.workflow.assessments.professional_dna.generational import GenerationalAnalysis
from app.ats.chatbot.workflow.assessments.cultural import (
    CulturalFitWorkflow,
    CulturalAnalysis
)
from app.ats.chatbot.workflow.assessments.talent import (
    TalentAnalysisWorkflow,
    TalentAnalysis
)
from app.ats.chatbot.workflow.assessments.personality import (
    PersonalityAssessment,
    PersonalityAnalysis
)
from app.ats.chatbot.workflow.assessments.generational import (
    GenerationalAnalysis,
    GenerationalPatterns,
    GenerationalInsights
)

from app.ats.chatbot.workflow.reports.professional_dna import ProfessionalDNAReport
from app.ats.chatbot.workflow.reports.cultural import CulturalReport
from app.ats.chatbot.workflow.reports.talent import TalentReport
from app.ats.chatbot.workflow.reports.personality import PersonalityReport
from app.ats.chatbot.workflow.reports.generational import GenerationalReport

from app.ats.chatbot.workflow.analysis.leadership import LeadershipAnalysis
from app.ats.chatbot.workflow.analysis.innovation import InnovationAnalysis
from app.ats.chatbot.workflow.analysis.communication import CommunicationAnalysis
from app.ats.chatbot.workflow.analysis.resilience import ResilienceAnalysis
from app.ats.chatbot.workflow.analysis.results import ResultsAnalysis
...
class MenuHandler:
    ...
    async def _handle_personality_test(self, platform: str, user_id: str) -> bool:
        ...
        try:
            from app.ats.chatbot.workflow.evaluaciones.personality_evaluation import PersonalityEvaluation
    ...
    async def _handle_talent_analysis(self, platform: str, user_id: str) -> bool:
        ...
        try:
            from app.ats.chatbot.workflow.evaluaciones.talent_evaluation import TalentEvaluation
    ...
    async def _handle_cultural_analysis(self, platform: str, user_id: str) -> bool:
        ...
        try:
            from app.ats.chatbot.workflow.evaluaciones.cultural_evaluation import CulturalEvaluation
