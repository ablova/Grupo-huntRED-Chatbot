...
from app.ats.ats.models import Contract, Proposal, Opportunity, Person
from app.ats.ats.ats.contracts.config import CONTRACTS_DIR
from app.ats.ats.ats.contracts.certificate_generator import CertificateGenerator
...
class ContractGenerator:
    ...
    def _notify_superuser(self, contract):
        ...
        Args:
            contract: Instancia de Contract
        """
        from app.ats.ats.utils.notification_handler import NotificationHandler
