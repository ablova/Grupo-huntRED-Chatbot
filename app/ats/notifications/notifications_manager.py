...
from app.ats.notifications.recipients import BaseRecipient
from app.ats.notifications.channels import BaseChannel
from app.ats.notifications.templates import BaseTemplate
from app.ats.notifications.config import NotificationsConfig
import logging

logger = logging.getLogger('app.ats.notifications.manager')
...
class NotificationsManager:
    ...
    def _get_channel_class(self, channel_type: str) -> BaseChannel:
        ...
        from app.ats.notifications.channels import EmailChannel, WhatsAppChannel, XChannel
    ...
    def _get_template_class(self, template_type: str) -> BaseTemplate:
        ...
        from app.ats.notifications.templates import ProposalTemplate, PaymentTemplate, OpportunityTemplate
