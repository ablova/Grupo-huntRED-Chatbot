...
from app.ats.notifications.recipients import CandidateRecipient, ConsultantRecipient, ClientRecipient
...
logger = logging.getLogger('app.ats.notifications.tests')
