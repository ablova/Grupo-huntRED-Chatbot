...
class BaseSkillAnalyzer(ABC):
    ...
    def __init__(self, business_unit: str, confidence_threshold: float = 0.5):
        """
        Inicializa el analizador.
        
        Args:
            business_unit: Unidad de negocio
            confidence_threshold: Umbral de confianza para el análisis
        """
    ...
    @abstractmethod
    async def analyze_competencies(self, competencies: List[Competency]) -> Dict[str, Any]:
        """
        Analiza un conjunto de competencias.
        
        Args:
            competencies: Lista de competencias a analizar
            
        Returns:
            Diccionario con el análisis de las competencias
        """
        pass
    ...
    def _load_weights(self) -> Dict:
        ...
        try:
            from app.ats.utils.analysis_weights import load_weights
    ...
    def get_skill_gaps(self, current_competencies: List[Competency], 
                      required_competencies: List[Competency]) -> List[Competency]:
        """
        Identifica brechas de habilidades.
        
        Args:
            current_competencies: Competencias actuales
            required_competencies: Competencias requeridas
            
        Returns:
            Lista de competencias faltantes
        """
        pass
