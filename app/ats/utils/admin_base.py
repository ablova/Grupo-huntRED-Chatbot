# Ubicación del archivo: /home/pablo/app/com/utils/admin_base.py
"""
...
configuraciones de administración en el sistema.
"""
...
class BaseModelAdmin(admin.ModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        for field in self.default_readonly_fields:
            if field in [f.name for f in self.model._meta.fields] and field not in readonly_fields:
