...
from app.ats.pagos.models import Oportunidad, Empleador, SincronizacionError, SincronizacionLog, Candidato
...
from app.ats.pagos.config.wordpress import WORDPRESS_CONFIG, WORDPRESS_SETTINGS
