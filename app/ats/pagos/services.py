...
class PagoService:
    ...
    def crear_pago(self, empleador: Person, vacante: Vacante, 
        ...
        Args:
            empleado: Persona que recibe el pago
            empleador: Persona que hace el pago
            vacante: Vacante asociada al pago
    ...
    def procesar_webhook(self, request_body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if estado == 'completed':
                pago.marcar_completo(request_body.get('transaction_id'))
            elif estado in ['failed', 'rejected']:
                pago.marcar_fallido(request_body.get('reason'))
