...
from app.chatbot.integrations.whatsapp import WhatsAppHandler, fetch_whatsapp_user_data
from app.chatbot.integrations.telegram import TelegramHandler, fetch_telegram_user_data
from app.chatbot.integrations.messenger import MessengerHandler, fetch_messenger_user_data
from app.chatbot.integrations.instagram import InstagramHandler, fetch_instagram_user_data
    ...
    async def send_document(self, platform: str, user_id: str, file_url: str, caption: str) -> bool:
        ...
        try:
            ...
            if platform == 'whatsapp':
                ...
                from app.chatbot.integrations.messenger import send_messenger_document
                ...
                from app.chatbot.integrations.slack import send_slack_document
