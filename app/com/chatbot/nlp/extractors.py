"""
Extractores de datos para Grupo huntRED®.
Proporciona funcionalidades para extraer y procesar datos de diferentes fuentes.
"""
...
logger = get_module_logger('nlp.extractors')
