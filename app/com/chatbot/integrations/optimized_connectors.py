...
class OptimizedGPTConnector:
    ...
    async def get_legacy_handler(self):
        ...
        try:
            ...
            gpt_module = await _import_module('app.com.utils.gpt')
...
class OptimizedNLPConnector:
    ...
    async def get_legacy_processor(self):
        ...
        try:
            ...
            nlp_module = await _import_module('app.com.utils.nlp')
    ...
    try:
        ...
        try:
            ...
            if hasattr(import_config, 'register_handler'):
                # GPT optimizado
                import_config.register_handler('gpt_handler', 'app.com.chatbot.optimized_connectors', 'OptimizedGPTConnector')
                logger.info("GPT optimizado registrado")
                
                # NLP optimizado
                import_config.register_handler('nlp_processor', 'app.com.chatbot.optimized_connectors', 'OptimizedNLPConnector')
