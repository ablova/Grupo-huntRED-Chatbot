...
async def procesar_respuesta_con_gpt(plataforma: str, user_id: str, texto: str, unidad_negocio: BusinessUnit, estado_chat: ChatState, persona: Person, gpt_handler):
    ...
    if bu_name == "amigro":
        from app.com.chatbot.workflow.amigro import continuar_perfil_amigro
        await continuar_perfil_amigro(plataforma, user_id, unidad_negocio, estado_chat, persona)
    elif bu_name == "huntu":
        from app.com.chatbot.workflow.huntu import continuar_perfil_huntu
...
async def transfer_candidate_to_new_division(person: Person, new_bu: BusinessUnit, plataforma: str, user_id: str):
    ...
    if bu_name == "huntu":
        ...
        from app.com.chatbot.workflow.huntred import continuar_perfil_huntred
        ...
        from app.com.chatbot.workflow.huntred_executive import continuar_perfil_huntred_executive
