...
from app.com.pricing.volume_pricing import VolumePricing, RecurringServicePricing
...
from app.com.pricing.proposal_renderer import ProposalRenderer, generate_proposal
...
def generate_talent_360_proposal_example(opportunity_id, output_format='html', output_file=None):
    ...
    try:
        ...
        from app.com.pricing.config import PROPOSAL_PRESETS
