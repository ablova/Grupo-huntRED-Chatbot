...
from app.publish.integrations.base_integration import BaseIntegration
...
class TelegramIntegration(BaseIntegration):
    ...
    def register_channel(self, channel_type: str, identifier: str, name: str) -> models.Model:
        ...
        """
        from app.models import Channel, ChannelCredential
    ...
    def register():
        ...
        """
        from app.publish.integrations import register_integration
