...
const GenIAAndAURASection = () => {
  ...
  return (
    <section id="genia-aura" className="py-20 bg-gradient-to-br from-background via-background to-muted/20 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-64 h-64 bg-gradient-to-r from-cyan-500/10 to-pink-500/10 rounded-full blur-2xl animate-float-delay" />
              ...
              <div className="relative">
                <div className="glass rounded-2xl p-8 border border-primary/20">
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-lg">
          ...
          <TabsContent value="ecosystem" className="space-y-8">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold mb-4">
                Ecosistema <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Integrado</span>
              </h3>
              ...
              {ecosystemFeatures.map((feature, index) => (
                <Card key={index} className="glass border-primary/20 hover:border-primary/40 transition-all hover:scale-105">
                  <CardHeader className="text-center pb-4">
                    <div className="mx-auto w-12 h-12 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-lg flex items-center justify-center mb-3">
