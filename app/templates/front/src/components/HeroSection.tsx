...
const HeroSection = () => {
  ...
  const slides = [
    {
      title: "Procesos de Reclutamiento optimizados con Inteligencia Artificial de Nueva Generación",
      subtitle: "Transformamos tu negocio con soluciones de IA avanzadas y personalizadas",
      description: "Desarrollamos sistemas inteligentes que se adaptan a las necesidades únicas de tu empresa, optimizando procesos y generando resultados medibles.",
    ...
    },
    {
      ...
      subtitle: "Algoritmos inteligentes que aprenden y evolucionan con tu negocio",
      description: "Implementamos modelos de ML que se integran perfectamente en tus flujos de trabajo, proporcionando insights valiosos y automatización inteligente.",
      cta: "Ver Casos de Éxito",
      image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
    },
    {
      title: "Ecosistema Tecnológico Completo",
      subtitle: "Desde la conceptualización hasta la implementación a escala",
      description: "Ofrecemos un stack completo de tecnologías de IA, desde chatbots conversacionales hasta sistemas de análisis predictivo avanzado.",
      cta: "Explorar Tecnologías",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                {slides[currentSlide].title.split(' ').map((word, index) => (
                  <span key={index} className={index >= 2 ? 'bg-tech-gradient bg-clip-text text-transparent' : ''}>
                    {word}{' '}
                  </span>
                ))}
              </h1>
          ...
          <div className="relative animate-slide-in-right">
            <div className="relative w-full h-[500px] rounded-2xl overflow-hidden glass">
              ...
              />
              <div className="absolute inset-0 bg-tech-gradient/20" />
            ...
            <div className="absolute -top-6 -right-6 glass rounded-xl p-4 animate-float">
              <div className="text-center">
                <div className="text-2xl font-bold bg-tech-gradient bg-clip-text text-transparent">500+</div>
