  ...
  const technologies = [
    {
      ...
      description: "Procesamiento avanzado de lenguaje natural para tener una conversacion eficiente",
    ...
    {
      title: "Proceso Integrado",
      description: "Complejo sistema con multiniveles de confirmacion de identidad, respuestas, y experiencia personalizada",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Impulsamos la innovación con las tecnologías de IA más avanzadas, diseñadas para resolver los desafíos más complejos de tu industria
          </p>
        </div>
          ...
          {technologies.map((tech, index) => (
            <button
              ...
              className={`px-6 py-3 rounded-full font-medium transition-all ${
                activeTab === index
                  ? 'bg-tech-gradient text-white shadow-lg'
              ...
              <CardContent className="p-0">
                <div className="relative h-[400px]">
                  ...
                  <div className="absolute bottom-4 right-4 space-y-2">
                    {technologies[activeTab].features.slice(0, 2).map((feature, index) => (
                      <div key={index} className="glass rounded-lg px-3 py-1">
