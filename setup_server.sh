...
echo "=== Conectando y configurando la instancia remota ==="
...
# Crear archivos de servicio systemd para Celery
...
sudo mkdir -p /home/pablo/scripts
...
EOF
sudo chmod +x /home/pablo/scripts/monitor_celery.sh
